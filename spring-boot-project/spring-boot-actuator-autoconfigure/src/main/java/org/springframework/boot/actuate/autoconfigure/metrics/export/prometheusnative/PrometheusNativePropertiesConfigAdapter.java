...
class PrometheusNativePropertiesConfigAdapter extends PropertiesConfigAdapter<PrometheusNativeProperties>
		implements PrometheusConfig {

	PrometheusNativePropertiesConfigAdapter(PrometheusNativeProperties properties) {
		super(properties);
	}
